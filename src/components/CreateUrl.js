                ...
                {({ errors, touched }) => (
                    <div className='container-fluid createUrl'>
                        <div className='login-form'>
                            <div className='createUrl-header text-center text-danger'><p>Create URL-Shortener</p></div>
                            <Form>
                                ...
                                <div className="form-group pt-2">
                                    <label htmlFor="longUrl" className='text-white'>URL</label>
                                    <Field name="longUrl" className="form-control" type="text" placeholder="Enter url" />
